...
<body class="antialiased">
    ...
    <section class="relative w-full h-[60vh] mt-32 overflow-hidden">
        <div class="w-full h-[500px] overflow-hidden">
            <img src="https://tedjaindonesia.ac.id/wp-content/uploads/2025/03/hall3-1536x1162.jpg" alt="Facility"
    ...
    <section class=" py-16 px-6 max-w-6xl mx-auto flex flex-col md:flex-row h-auto md:h-[80vh]">
        ...
        <div class="w-[50] h-[40vh]">
            <img src="https://tedjaindonesia.ac.id/wp-content/uploads/2025/04/dosen2-1536x830.jpg" alt="Gedung 1"
        ...
        <div class="w-full md:w-1/2 flex items-center justify-center bg-white px-8 md:px-12 py-10 md:py-0">
            <div>
                ...
                <p class="text-base md:text-lg text-gray-700 mb-6">
                    All our facilities are designed with input from industry professionals to ensure they reflect
                    current industry standards and practices. Students spend 60% of their learning time in these
                    practical environments, gaining hands-on experience that prepares them for successful careers.</p>
                <p class="text-base md:text-lg text-gray-700 mb-6">Our campus is regularly updated with the latest
                    equipment and technology to ensure students are familiar with the tools and systems they will
                    encounter in the workplace.</p>
            </div>
        </div>
    </section>
    ...
    <section class="py-10 px-40 max-w-7xl mx-auto bg-gray-100">
        ...
        <div id="facilities" class="grid grid-cols-1 md:grid-cols-2 gap-4">
            ...
            <script>
                fetch("http://127.0.0.1:8000/api/facilities")
                    ...
                    .then(facilities => {
                        ...
                        facilities.data.forEach(p => {
                            container.innerHTML += `
        <div class="bg-white border rounded-2xl shadow-lg overflow-hidden hover:shadow-2xl transition duration-300">
                <div class="overflow-hidden">
                    <img src="http://127.0.0.1:8000/images/facilities/${p.image}" class="w-full h-56 object-cover" alt="${p.name}"
