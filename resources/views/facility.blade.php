...
<head>
    ...
    <title>Facility - Tedja Indonesia</title>
...
<body class="antialiased">
    ...
    <!-- Hero Section -->
    <section class="relative w-full h-[60vh] mt-32 overflow-hidden">
        <div class="w-full h-[500px] overflow-hidden">
            <img src="https://tedjaindonesia.ac.id/wp-content/uploads/2025/03/hall3-1536x1162.jpg"
                 alt="Facility"
    ...
    <section class="py-16 px-6 max-w-6xl mx-auto">
        <h2 class="text-4xl font-bold text-gray-800 mb-4">Our Learning Environments</h2>
        <p class="text-lg text-gray-600 leading-relaxed">
            At Tedja Indonesia, we believe in learning by doing. Our specially designed facilities simulate
            real-world hospitality and tourism environments, allowing students to practice and hone
            their skills before entering the industry.
        </p>
    </section>
...
<section class=" py-16 px-6 max-w-6xl mx-auto flex flex-col md:flex-row h-auto md:h-[80vh]">
    <!-- Gambar Kiri (atau atas di HP) -->
    <div class="w-[50] h-[40vh]">
        <img src="https://tedjaindonesia.ac.id/wp-content/uploads/2025/04/dosen2-1536x830.jpg"
             alt="Gedung 1"
             class="w-full h-[20vh] md:h-full object-cover">
    </div>

    <!-- Teks Kanan (atau bawah di HP) -->
    <div class="w-full md:w-1/2 flex items-center justify-center bg-white px-8 md:px-12 py-10 md:py-0">
        <div>
            ...
            <p class="text-base md:text-lg text-gray-700 mb-6">
                All our facilities are designed with input from industry professionals to ensure they reflect current industry standards and practices. Students spend 60% of their learning time in these practical environments, gaining hands-on experience that prepares them for successful careers.</p>
            <p class="text-base md:text-lg text-gray-700 mb-6"
            >Our campus is regularly updated with the latest equipment and technology to ensure students are familiar with the tools and systems they will encounter in the workplace.</p>
        </div>
    </div>
</section>
    ...
    <section class="py-10 px-40 max-w-7xl mx-auto bg-gray-100">
        <h2 class="text-3xl font-semibold text-center mb-12 text-gray-800">
            Explore Our Facilities
        </h2>
        <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
            <!-- Hotel Training Room -->
            <div class="bg-white border rounded-2xl shadow-lg overflow-hidden hover:shadow-2xl transition duration-300">
                <div class="overflow-hidden">
                    <img src="https://tedjaindonesia.ac.id/wp-content/uploads/2025/04/aloft2-1536x1111.jpg"
                         alt="Hotel Training Room"
                         class="w-full h-64 object-cover">
                </div>
                <div class="p-6">
                    <h3 class="text-xl font-semibold mb-2">Hotel Training Room</h3>
                    <p class="text-gray-600">
                        Professional hotel room setups where students practice housekeeping, room service, and hospitality management in a realistic environment.
                    </p>
                </div>
            </div>
            ...
            <div class="bg-white border rounded-2xl shadow-lg overflow-hidden hover:shadow-2xl transition duration-300">
                <div class="overflow-hidden">
                    <img src="https://tedjaindonesia.ac.id/wp-content/uploads/2025/04/kantin3-1536x812.jpg"
                         alt="Culinary Laboratory"
                         class="w-full h-64 object-cover transform">
                </div>
                <div class="p-6">
                    <h3 class="text-xl font-semibold mb-2">Culinary Laboratory</h3>
                    <p class="text-gray-600">
                        Fully-equipped professional kitchens where students learn food preparation, presentation, and international cuisine techniques.
                    </p>
                </div>
            </div>
            ...
            <div class="bg-white border rounded-2xl shadow-lg overflow-hidden hover:shadow-2xl transition duration-300">
                <div class="overflow-hidden">
                    <img src="https://tedjaindonesia.ac.id/wp-content/uploads/2025/04/audit1-1536x1359.jpg"
                         alt="Auditorium"
                         class="w-full h-64 object-cover transform">
                </div>
                <div class="p-6">
                    <h3 class="text-xl font-semibold mb-2">Conference Center</h3>
                    <p class="text-gray-600">
                       A professional venue for events and conferences where students gain hands-on experience in event planning and management.
                    </p>
                </div>
            </div>
            ...
            <div class="bg-white border rounded-2xl shadow-lg overflow-hidden hover:shadow-2xl transition duration-300">
                <div class="overflow-hidden">
                    <img src="https://tedjaindonesia.ac.id/wp-content/uploads/2025/04/bed01-1536x1152.jpg"
                         alt="Dormitory"
                         class="w-full h-64 object-cover transform">
                </div>
                <div class="p-6">
                    <h3 class="text-xl font-semibold mb-2">Student Dormitory Room</h3>
                    <p class="text-gray-600">
                        Cozy, functional living spaces that provide students with comfort, privacy, and a supportive environment for rest, study, and daily life on campus.
                    </p>
                </div>
            </div>
        </div>
